...
def mainlist(item):
    ...
    itemlist.append(Item(channel=item.channel, action="peliculas", title="Películas",
                         ...
                         thumbnail="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/squares/thumb_biblioteca_peliculas.png"))
    itemlist.append(Item(channel=item.channel, action="series", title="Series",
                         category="Biblioteca de series",
                         thumbnail="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/squares/thumb_biblioteca_series.png"))
