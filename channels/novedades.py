...
def mainlist(item,thumbnail_type="squares"):
    ...
    thumbnail_base = "https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/"+thumbnail_type+"/"
...
def get_newest(channel_id, categoria):
    ...
    try:
        ...
        logger.info("mitvspain.channels.novedades running channel "+modulo.__name__+" "+modulo.__file__)
        list_result = modulo.newest(categoria)
        logger.info("mitvspain.channels.novedades.get_newest canal= %s %d resultados" %(channel_id, len(list_result)))

        for item in list_result:
            #logger.info("mitvspain.channels.novedades.get_newest   item="+item.tostring())
...
def menu_opciones(item):
    ...
    itemlist.append(Item(channel=item.channel, title="Canales incluidos en:",
                         thumbnail="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/" + preferred_thumbnail + "/thumb_configuracion_0.png",
                         folder=False))
    itemlist.append(Item(channel=item.channel, action="settingCanal", extra="peliculas", title="    - Películas ",
                         thumbnail="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/" + preferred_thumbnail + "/thumb_canales_peliculas.png",
                         folder=False))
    itemlist.append(Item(channel=item.channel, action="settingCanal", extra="infantiles", title="    - Para niños",
                         thumbnail="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/" + preferred_thumbnail + "/thumb_canales_infantiles.png",
                         folder=False))
    itemlist.append(Item(channel=item.channel, action="settingCanal", extra="series", title="    - Episodios de series",
                         thumbnail="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/" + preferred_thumbnail + "/thumb_canales_series.png",
                         folder=False))
    itemlist.append(Item(channel=item.channel, action="settingCanal", extra="anime", title="    - Episodios de anime",
                         thumbnail="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/" + preferred_thumbnail + "/thumb_canales_anime.png",
                         folder=False))
    itemlist.append(Item(channel=item.channel, action="settingCanal", extra="documentales", title="    - Documentales",
                         thumbnail="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/" + preferred_thumbnail + "/thumb_canales_documentales.png",
                         folder=False))
