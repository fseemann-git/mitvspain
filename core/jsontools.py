...
def xmlTojson(path_xml):
    ...
    try:
        ...
        import traceback
        logger.info("mitvspain.core.jsontools xmlTojson ERROR al leer el fichero y/o crear el json de " + path_xml)
        logger.info("mitvspain.core.jsontools " + traceback.format_exc())
