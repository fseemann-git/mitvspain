...
def test_video_exists(page_url):
    logger.info("mitvspain.servers.allmyvideos test_video_exists(page_url='%s')" % page_url)
...
def get_video_url(page_url, premium=False, user="", password="", video_password=""):
    logger.info("mitvspain.servers.allmyvideos url=%s" % page_url)
    ...
    if media_url != "":
        ...
        for video_url in video_urls:
            logger.info("mitvspain.servers.allmyvideos %s - %s" % (video_url[0], video_url[1]))
...
def find_videos(data):
    ...
    logger.info("mitvspain.servers.allmyvideos find_videos #" + patronvideos + "#")
